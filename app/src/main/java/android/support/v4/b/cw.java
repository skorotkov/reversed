...
public class cw implements bq {
   private Builder a;

   public cw(Context var1, Notification var2, CharSequence var3, CharSequence var4, CharSequence var5, RemoteViews var6, int var7, PendingIntent var8, PendingIntent var9, Bitmap var10, int var11, int var12, boolean var13) {
      ...
      this.a = var15.setFullScreenIntent(var9, var14).setLargeIcon(var10).setNumber(var7).setProgress(var11, var12, var13);
   }
