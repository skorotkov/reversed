...
public class GeneralRunningTrainingProgram extends TrainingTargetTrainingProgram implements EventProgramEnablerGeneralRunningProgram {
      ...
      if (this != var1) {
         if (var1 != null && this.getClass() == var1.getClass()) {
            if (!super.equals(var1)) {
               ...
               label117: {
                  GeneralRunningTrainingProgram var3 = (GeneralRunningTrainingProgram)var1;
