...
class v_GpsRouteSample extends ai_Sample {
   ...
   private v_GpsRouteSample() {
      this(0, 0L, false, 0.0D, 0.0D, -1.0D, 0);
   }

   v_GpsRouteSample(int var1, long var2, f_PolarSensorEvent var4) {
      this(var1, var2, var4.n_fix, var4.h_latitude, var4.i_longitude, var4.k_altitudeInMeters, var4.g_numberOfSatellites);
   }

   v_GpsRouteSample(int var1, long var2, boolean var4, double var5, double var7, double var9, int var11) {
   ...
   // $FF: synthetic method
   v_GpsRouteSample(u var1) {
      this();
   }

   // $FF: synthetic method
   static double a_getLatitude(v_GpsRouteSample var0) {
      return var0.a_latitude;
   }

   // $FF: synthetic method
   static double b_getLongitude(v_GpsRouteSample var0) {
      return var0.b_longitude;
   }

   // $FF: synthetic method
   static double c_getAltitudeInMeters(v_GpsRouteSample var0) {
      return var0.d_altitudeInMeters;
   }

   // $FF: synthetic method
   static int d_getNumberOfSatellites(v_GpsRouteSample var0) {
