...
public class Training {
   ...
   private final aa mSystemClock = new aa();
   ...
   public long getPausedTime() {
      long var1;
      if (this.mPaused) {
         var1 = this.mSystemClock.b() - this.mPauseStart + this.mPausedTime;
      } else {
   ...
   public TrainingDataRefs getTrainingDataRefs(boolean var1) {
      if (var1 && this.mRunning) {
         this.setEndTimeAndDuration(this.mSystemClock.b());
      }
   ...
   public long pauseSession() {
      if (!this.mPaused) {
         this.mPauseStart = this.mSystemClock.b();
   ...
   public void resumeSession() {
      if (this.mPaused) {
         this.mPauseEnd = this.mSystemClock.b();
   ...
   public void startSession() {
      ...
      if (!this.mRunning) {
         ...
         this.mPausedTime = 0L;
         this.mPauseEnd = 0L;
         this.mTrainingSession = new TrainingSession(this.mSystemClock.a(), this.mSystemClock.b());
            ...
            if (var3 != -1L) {
               ...
               if (this.mExerciseTargetInfo.getTargetType() == 1) {
                  ...
                  for(var6 = 0; var6 < var7.size(); var6 = var9 + 1) {
                     ExercisePhase var8 = (ExercisePhase)var7.get(var6);
                     var8.increaseTotalExecutionCount();
                     ++var11[var6];
                     this.mPhaseExecutionOrder.add(var6);
                     var9 = var6;
                     if (var8.getRepeatCount() != -1) {
                        if (var11[var6] < var8.getRepeatCount() + 1) {
                           var9 = var8.getJumpIndex() - 2;
                        } else {
                           var11[var6] = 0;
                           var9 = var6;
                        }
