...
class t implements Runnable {
   ...
   public void run() {
      ...
      TrainingDataRefs var1 = TrainingService.b(this.a).getTrainingDataRefs(false);
      TrainingService.b(this.a).stopSessionAndRelease();
      this.a.stopForeground(true);
      TrainingService.a(this.a, "TrainingService.action.TRAINING_STOPPED", var1.getEndTimeFromBoot());
      if (TrainingService.g(this.a)) {
         TrainingService.h(this.a).a(this.a.getApplicationContext(), true);
      } else {
         TrainingService.a(this.a, var1, TrainingService.i(this.a));
      }
