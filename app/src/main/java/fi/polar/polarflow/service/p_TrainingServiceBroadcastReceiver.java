...
class p_TrainingServiceBroadcastReceiver extends BroadcastReceiver {
   ...
   public void onReceive(Context var1, Intent var2) {
      ...
      if (TrainingService.a(this.a_trainingService) == 2) {
         ...
         if (TrainingService.a(this.a_trainingService) == 1) {
      ...
      } else if ("DailyActivityService.action.TRAINING_LOAD_DATA".equals(var5) && TrainingService.a(this.a_trainingService) == 1) {
