...
class ba extends b {
   private final fi.polar.polarflow.util.b_package.a a;

   public ba(Context var1, fi.polar.polarflow.util.z var2, fi.polar.polarflow.service.datalayer.u var3, fi.polar.polarflow.util.b_package.a var4, boolean var5) {
      super(var1, var2, var3, var5);
      this.a = var4;
   }

   private static SleepAnalysisResult a(fi.polar.polarflow.util.b_package.a var0) {
