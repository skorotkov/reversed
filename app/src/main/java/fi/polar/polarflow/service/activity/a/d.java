...
public class d {
   ...
   private int a(RecoveryTimes var1) {
      return fi.polar.polarflow.service.activity.a.g.b(var1) + (int)this.h.c_();
   }
   ...
   private DailySummary a(LocalDate var1) {
      ...
      if (this.q != null && this.q.getDate().equals(var1)) {
         ...
         var2 = fi.polar.polarflow.service.activity.a.e.a(var1);
      }
   ...
   private void a(DateTime var1, boolean var2) {
      ...
      if (var3 != null) {
         ...
         if (var2) {
            ...
            fi.polar.polarflow.service.activity.a.g.a(var3);
            var4 = var3;
         }
      } else {
         var4 = fi.polar.polarflow.service.activity.a.g.a();
      }
   ...
   private boolean a(RecoveryTimes var1, boolean var2, boolean var3) {
      ...
      if (var3) {
         fi.polar.polarflow.service.activity.a.e.a(this.q);
      }
   ...
   private float b(RecoveryTimes var1) {
      return fi.polar.polarflow.service.activity.a.g.c(var1) + this.i.c_();
   }
   ...
   private double c(RecoveryTimes var1) {
      return (double)fi.polar.polarflow.service.activity.a.g.d(var1) + this.j.b();
   }
   ...
   private double d(RecoveryTimes var1) {
      return (double)fi.polar.polarflow.service.activity.a.g.e(var1) + this.j.c();
   }
   ...
   private double e(RecoveryTimes var1) {
      return (double)fi.polar.polarflow.service.activity.a.g.f(var1) + this.j.d();
   }
   ...
   private RecoveryTimes i() {
      if (this.p == null) {
         this.p = fi.polar.polarflow.service.activity.a.g.b();
      }
   ...
   public void a(List var1) {
      ...
      if (this.a(var4)) {
         ...
         while(var7.hasNext()) {
            o var12 = (o)var7.next();
            if (fi.polar.polarflow.service.activity.a.c.a(var12, var3.minusMillis(1), var2)) {
               this.a(var12);
            }
         }
         ...
         while(var11.hasNext()) {
            o var8 = (o)var11.next();
            if (fi.polar.polarflow.service.activity.a.c.a((o)var8, var2, (DateTime)null)) {
               this.a(var8);
            }
         }
      } else {
         ...
         while(var9.hasNext()) {
            o var10 = (o)var9.next();
            if (fi.polar.polarflow.service.activity.a.c.a((o)var10, var3.minusMillis(1), (DateTime)null)) {
               this.a(var10);
            }
         }
      }
   ...
   public boolean a(boolean var1) {
      ...
      if (this.a(var2)) {
         if (this.b(var2)) {
            ...
            this.a(this.i(), fi.polar.polarflow.service.activity.a.e.a(var3), true);
            this.h();
            this.a(var2, true);
         } else {
            this.a(var2, false);
