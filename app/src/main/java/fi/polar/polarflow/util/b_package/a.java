...
public class a implements Parcelable {
   ...
   private a(c var1) {
      this.a = fi.polar.polarflow.util.b_package.c.a(var1);
      this.b = fi.polar.polarflow.util.b_package.c.b(var1);
      this.c = fi.polar.polarflow.util.b_package.c.c(var1);
      this.d = fi.polar.polarflow.util.b_package.c.d(var1);
      this.e = fi.polar.polarflow.util.b_package.c.e(var1);
      this.f = fi.polar.polarflow.util.b_package.c.f(var1);
      this.g = fi.polar.polarflow.util.b_package.c.g(var1);
      this.h = fi.polar.polarflow.util.b_package.c.h(var1);
      this.i = fi.polar.polarflow.util.b_package.c.i(var1);
      this.j = fi.polar.polarflow.util.b_package.c.j(var1);
      this.k = fi.polar.polarflow.util.b_package.c.k(var1);
      this.l = fi.polar.polarflow.util.b_package.c.l(var1);
      this.m = fi.polar.polarflow.util.b_package.c.m(var1);
      this.n = fi.polar.polarflow.util.b_package.c.n(var1);
   }
