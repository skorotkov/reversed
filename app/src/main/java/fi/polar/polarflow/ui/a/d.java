...
public abstract class d extends fi.polar.polarflow.ui.exeview.a.a.ah {
   private TextView a;
   private TextView c;
   private TextView d;
   ...
   public int a() {
      int var1;
      switch(fi.polar.polarflow.ui.a.e.a[this.l().ordinal()]) {
      case 1:
         var1 = 2130968651;
         break;
      case 2:
   ...
   public void b(int var1) {
      if (this.d != null) {
         this.d.setText(String.valueOf(fi.polar.polarflow.a.a.a(9, var1)));
      }
