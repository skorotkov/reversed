...
public class ab extends fi.polar.polarflow.ui.a.k {
   private List d = null;
   private int[] e = null;
   ...
   private void b(Intent var1) {
      if ("fi.polar.polarflow.ACTION_HR_DATA".equals(var1.getAction())) {
         ...
         this.b(var2);
         this.a(var2);
      } else if ("fi.polar.polarflow.SENSOR_HR_STATE_CHANGED".equals(var1.getAction()) && (fi.polar.polarflow.c.m)var1.getSerializableExtra("fi.polar.polarflow.SENSOR_STATE") != fi.polar.polarflow.c.m.d) {
         this.b(0);
         this.a(0);
      }
