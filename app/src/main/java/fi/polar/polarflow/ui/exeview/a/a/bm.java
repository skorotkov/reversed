...
public class bm extends fi.polar.polarflow.ui.a.z {
   public bm() {
      super((new fi.polar.polarflow.ui.a.ae()).a(2131230897).b(2131230895).c(2131230893).b("SwimmingMetricsProvider.KEY_POOL_SWIMMING_MAXIMUM_SPEED").a());
   }
