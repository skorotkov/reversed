...
public class b extends fi.polar.polarflow.service.activity.b {
   private final v_StickyLocalBroadcastManager a;
   private final String b;
   private final int c;

   public b(Context var1, z var2, u var3, v_StickyLocalBroadcastManager var4, String var5, int var6) {
      this(var1, var2, var3, var4, var5, var6, true);
   }

   public b(Context var1, z var2, u var3, v_StickyLocalBroadcastManager var4, String var5, int var6, boolean var7) {
   ...
   private void a(int var1, DateTime var2) {
      Intent var3 = this.a.a_registerReceiver((BroadcastReceiver)null, (String)"SleepTrackingService.action.SLEEP_ANALYSIS_RESULT");
      if (var3 != null) {
         ...
         if (this.b.equals(var4.c())) {
            ...
            this.a.b_sendStickyBroadcast(var3);
         }
      }
