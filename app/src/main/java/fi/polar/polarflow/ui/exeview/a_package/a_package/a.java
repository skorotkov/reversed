...
class a extends fi.polar.polarflow.ui.a_package.m {
   ...
   private void c(Intent var1) {
      if (var1 != null && "ExerciseLapCalc.ACTION_AUTO_LAP_DATA_GPS".equals(var1.getAction()) && this.e() == var1.getIntExtra("ExerciseLapCalc.KEY_LAP_NUMBER", -1)) {
         this.a(var1.getFloatExtra("ExerciseLapCalc.KEY_ASCENT", 0.0F));
      }
   ...
   public int a() {
      int var1;
      switch(fi.polar.polarflow.ui.exeview.a_package.a_package.b.a[this.l().ordinal()]) {
      case 1:
         var1 = 2130968648;
         break;
      default:
