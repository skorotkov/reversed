...
class o extends fi.polar.polarflow.ui.a_package.c {
   private void b(Intent var1) {
      if (var1 != null && "fi.polar.polarflow.ACTION_LOCATION_DATA".equals(var1.getAction())) {
         this.a(var1.getFloatExtra("fi.polar.polarflow.KEY_SENSOR_LOCATION_ASCENT_VALUE", 0.0F));
      }

   }

   private void e() {
      this.a(this.P.getFloat(J, 0.0F));
   }

   public int a() {
      int var1;
      switch(fi.polar.polarflow.ui.exeview.a_package.a_package.p.a[this.l().ordinal()]) {
      case 1:
         var1 = 2130968648;
         break;
      default:
