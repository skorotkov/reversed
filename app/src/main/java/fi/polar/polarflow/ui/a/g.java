...
public abstract class g extends fi.polar.polarflow.ui.exeview.a.a.ah {
   private static final String c = fi.polar.polarflow.a.a.a(1, 99.9990005493164D);
   protected int a = 1;
   private TextView d;
   private TextView e;
   private TextView f;
   ...
   private void c(float var1) {
      this.e.setVisibility(8);
      this.e.setText("");
      float var2 = fi.polar.polarflow.a.a.a(1, var1);
      String var3;
      if (this.h == 1) {
         var1 = fi.polar.polarflow.ui.o.e(var2);
         var3 = fi.polar.polarflow.a.a.a(this.a, (double)var1);
      } else {
         var3 = fi.polar.polarflow.a.a.a(this.a, (double)var2);
      }
   ...
   public int a() {
      int var1;
      switch(fi.polar.polarflow.ui.a.h.a[this.l().ordinal()]) {
      case 1:
         var1 = 2130968658;
         break;
      case 2:
   ...
   public void a(float var1) {
      var1 = fi.polar.polarflow.a.a.a(1, var1);
      if (this.n()) {
         this.c(var1);
      } else {
         this.b(var1);
   ...
   public void a(View var1) {
      ...
      if (this.n()) {
         if (this.P != null) {
            this.h = this.P.getInt(fi.polar.polarflow.ui.exeview.a.a.ah.O, 0);
         } else {
