...
public class g extends ah {
   ...
   private void b(Intent var1) {
      if (var1 != null) {
         if (var1.getAction().equals("fi.polar.polarflow.ACTION_HR_DATA")) {
            ...
            if ((m_SENSOR_STATE)var1.getSerializableExtra("fi.polar.polarflow.SENSOR_STATE") != m_SENSOR_STATE.d_READY) {
               this.f = -1;
               this.c(0);
               this.e();
            }
   ...
   public void d() {
      this.c(Math.round(this.Q.getStatistics().getHeartrateStatistics().i_getMostResentSample()));
      this.v();
      this.e();
   }
