...
class ar extends fi.polar.polarflow.ui.a_package.r {
   private void b(Intent var1) {
      if (var1 != null && "ExerciseLapCalc.ACTION_MANUAL_LAP_DATA_HR".equals(var1.getAction()) && this.e() == var1.getIntExtra("ExerciseLapCalc.KEY_LAP_NUMBER", -1)) {
   ...
   public void a(Intent var1) {
      ...
      if ("ExerciseLapCalc.ACTION_MANUAL_LAP".equals(var2)) {
         this.c(var1);
      } else if ("ExerciseLapCalc.ACTION_MANUAL_LAP_DATA_HR".equals(var2)) {
         this.b(var1);
      }
