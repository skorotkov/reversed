...
class g extends fi.polar.polarflow.ui.a_package.o {
   private Pair c = Pair.create("ExerciseLapCalc.ACTION_AUTO_LAP_DATA_GPS", "ExerciseLapCalc.KEY_DISTANCE");
   ...
   public void a(View var1) {
      ...
      this.a(0.0F);
      if (this.n()) {
         this.c = Pair.create("SwimmingMetricsProvider.ACTION_POOL_SWIMMING_OUTPUT_DATA", "SwimmingMetricsProvider.KEY_POOL_SWIMMING_AUTO_LAP_DISTANCE");
         this.d = "SwimmingMetricsProvider.KEY_POOL_SWIMMING_AUTO_LAP_NUMBER";
      }
