...
public class c extends ah {
   ...
   public void a(float var1) {
      ...
      if (this.n()) {
         if (this.j == 0) {
            var2 = fi.polar.polarflow.a.a.a(17, (double)this.f);
            var3 = fi.polar.polarflow.a.a.a(18, (double)this.g);
         } else {
            var2 = fi.polar.polarflow.a.a.a(17, (double)fi.polar.polarflow.ui.o.e(this.f));
            var3 = fi.polar.polarflow.a.a.a(18, (double)fi.polar.polarflow.ui.o.e(this.g));
         }
      } else {
