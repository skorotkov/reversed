...
public class s extends a {
   ...
   private Sensor j;
   private boolean k;
   private fi.polar.polarflow.c_package.e l = null;
   private final Handler m = new Handler();
   private final fi.polar.polarflow.c_package.j n = new u(this);
   ...
   // $FF: synthetic method
   static fi.polar.polarflow.c_package.e a(s var0) {
      return var0.l;
   }

   // $FF: synthetic method
   static void a(s var0, fi.polar.polarflow.c_package.m var1) {
      var0.a((fi.polar.polarflow.c_package.m)var1);
   }

   // $FF: synthetic method
   static void b(s var0, fi.polar.polarflow.c_package.m var1) {
      var0.a((fi.polar.polarflow.c_package.m)var1);
   }
   ...
   public void a(fi.polar.polarflow.c_package.l var1) {
      this.l = (fi.polar.polarflow.c_package.e)var1;
   }
   ...
   public void b() {
      ...
      if (fi.polar.polarflow.ui.o.d(this.a, "android.permission.BODY_SENSORS")) {
         if (!this.k) {
            this.r();
            if (this.k) {
               this.a(fi.polar.polarflow.c_package.m.c, true);
            } else {
