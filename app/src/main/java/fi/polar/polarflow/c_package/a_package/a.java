...
public class a extends fi.polar.polarflow.c_package.a implements i {
   ...
   private Handler q;
   private fi.polar.polarflow.c_package.e r;
   private long s;
   ...
   public void a(l var1) {
      this.r = (fi.polar.polarflow.c_package.e)var1;
   }
   ...
   public void b() {
      if (!this.d) {
         ...
         this.l();
         if (this.n()) {
            this.a((m)fi.polar.polarflow.c_package.m.d);
            this.d = true;
         } else {
            this.a((m)fi.polar.polarflow.c_package.m.a);
            this.m();
         }
      }
   ...
   public void c() {
      if (this.d) {
         ...
         this.m();
         this.a((m)fi.polar.polarflow.c_package.m.b);
         this.d = false;
