...
public abstract class a extends fi.polar.polarflow.c.a implements fi.polar.polarflow.c.i {
   ...
   public fi.polar.polarflow.c.f k() {
   ...
   public float o() {
      return fi.polar.polarflow.a.a.a(1, this.l - (this.n + this.m));
   }
