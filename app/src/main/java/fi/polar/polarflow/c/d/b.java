...
public class b extends a {
   ...
   private fi.polar.polarflow.c.e A;
   private boolean B;
   ...
   private aa F;
   private n G;
   private final fi.polar.polarflow.c.j H;
   private final fi.polar.polarflow.c.g I;
   ...
   b(Context var1, LocationDataCalculatorAndroidImpl var2) {
      super(var1, fi.polar.polarflow.c.n.b);
      this.y = null;
      this.A = null;
      this.C = new Handler();
      this.D = 0L;
   ...
   // $FF: synthetic method
   static fi.polar.polarflow.c.e a(b var0) {
      return var0.A;
   }
   ...
   // $FF: synthetic method
   static fi.polar.polarflow.c.g e(b var0) {
      return var0.I;
   }
   ...
   // $FF: synthetic method
   static fi.polar.polarflow.c.n o(b var0) {
      return var0.c;
   }
   ...
   protected void a() {
      ...
      this.i = fi.polar.polarflow.a.a.b(4, this.x.getAltitudeInMeters(true));
   }

   public void a(l var1) {
      this.A = (fi.polar.polarflow.c.e)var1;
   }

   public void a(m var1) {
      if (fi.polar.polarflow.c.m.d.equals(var1)) {
         if (!this.x.getFix()) {
            super.a(fi.polar.polarflow.c.m.c, false);
         } else {
            super.a(var1, false);
         }
      } else {
   ...
   public void b() {
      ...
      if (!fi.polar.polarflow.ui.o.d(this.a, "android.permission.ACCESS_FINE_LOCATION")) {
         ...
         if (this.G.a()) {
            ...
            fi.polar.polarflow.c.d.i.b(this.z);
         }
      } else {
         this.d();
      }
   ...
   public void c() {
      ...
      if (this.d) {
         ...
         fi.polar.polarflow.c.d.i.c(this.z);
      } else {
         this.d();
      }

      this.C.removeCallbacksAndMessages((Object)null);
      fi.polar.polarflow.c.d.i.d(this.z);
   }

   public void d() {
      fi.polar.polarflow.c.d.i.e(this.z);
   }
   ...
   public void h() {
      super.h();
      if (this.d && this.B) {
         fi.polar.polarflow.c.d.i.a(this.z);
      }
