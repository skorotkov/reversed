...
public class b extends a {
   ...
   private fi.polar.polarflow.c.l A = null;
   ...
   private void F() {
      if (!this.a(fi.polar.polarflow.c.b.i.a, fi.polar.polarflow.c.b.i.h)) {
   ...
   private void G() {
      if (!this.a(fi.polar.polarflow.c.b.i.a, fi.polar.polarflow.c.b.i.d)) {
   ...
   private void H() {
      if (!this.a(fi.polar.polarflow.c.b.i.a, fi.polar.polarflow.c.b.i.e)) {
   ...
   private void I() {
      if (!this.a(fi.polar.polarflow.c.b.i.a, fi.polar.polarflow.c.b.i.f)) {
   ...
   private void J() {
      if (!this.a(fi.polar.polarflow.c.b.i.a, fi.polar.polarflow.c.b.i.g)) {
   ...
   // $FF: synthetic method
   static int a(b var0, int var1) {
      var0.m = var1;
      return var1;
   }

   // $FF: synthetic method
   static fi.polar.polarflow.service.bluetooth.j a(b var0) {
      return var0.j;
   }
   ...
   // $FF: synthetic method
   static String a(b var0, String var1) {
      var0.p = var1;
      return var1;
   }
   ...
   // $FF: synthetic method
   static void a(b var0, BluetoothGattCharacteristic var1) {
      var0.e(var1);
   }

   // $FF: synthetic method
   static void a(b var0, BluetoothGattCharacteristic var1, int var2) {
      var0.a(var1, var2);
   }

   // $FF: synthetic method
   static void a(b var0, fi.polar.polarflow.c.m var1) {
   ...
   private void a(boolean var1) {
      BluetoothGattCharacteristic var2 = this.b(fi.polar.polarflow.c.b.i.b, fi.polar.polarflow.c.b.i.i);
      if (var2 != null) {
         BluetoothGattDescriptor var3 = var2.getDescriptor(fi.polar.polarflow.c.b.i.j);
         if (var3 != null) {
            this.a(var3, var1);
         } else {
   ...
   // $FF: synthetic method
   static String b(b var0, String var1) {
      var0.q = var1;
      return var1;
   }
   ...
   // $FF: synthetic method
   static void b(b var0, BluetoothGattCharacteristic var1, int var2) {
      var0.b(var1, var2);
   }

   // $FF: synthetic method
   static void b(b var0, fi.polar.polarflow.c.m var1) {
      var0.a((fi.polar.polarflow.c.m)var1);
   }

   // $FF: synthetic method
   static int c(b var0, int var1) {
      var0.v = var1;
      return var1;
   }
   ...
   private void c(int var1) {
      ...
      if (var2 != null && !var2.getAvailableFeaturesSet().contains(var1)) {
         ...
         var2.save();
         var2.publish(this.a);
         fi.polar.polarflow.util.w.a(this.a, var2.getPath() + var2.getFilename());
      }
   ...
   // $FF: synthetic method
   static void c(b var0, BluetoothGattCharacteristic var1, int var2) {
      var0.c(var1, var2);
   }

   // $FF: synthetic method
   static void c(b var0, fi.polar.polarflow.c.m var1) {
      var0.a((fi.polar.polarflow.c.m)var1);
   }
   ...
   // $FF: synthetic method
   static void d(b var0, BluetoothGattCharacteristic var1, int var2) {
      var0.d(var1, var2);
   }

   // $FF: synthetic method
   static void d(b var0, fi.polar.polarflow.c.m var1) {
      var0.a((fi.polar.polarflow.c.m)var1);
   }
   ...
   // $FF: synthetic method
   static void e(b var0, BluetoothGattCharacteristic var1, int var2) {
      var0.e(var1, var2);
   }

   // $FF: synthetic method
   static void e(b var0, fi.polar.polarflow.c.m var1) {
      var0.a((fi.polar.polarflow.c.m)var1);
   }

   // $FF: synthetic method
   static void f(b var0) {
      var0.x();
   }

   // $FF: synthetic method
   static String g(b var0) {
      return var0.t();
   }

   // $FF: synthetic method
   static void h(b var0) {
      var0.B();
   }

   // $FF: synthetic method
   static BluetoothAdapter i(b var0) {
      return var0.i;
   }

   // $FF: synthetic method
   static void j(b var0) {
      var0.y();
   }
   ...
   // $FF: synthetic method
   static BleDevice n(b var0) {
      return var0.r();
   }

   // $FF: synthetic method
   static void o(b var0) {
      var0.F();
   }

   // $FF: synthetic method
   static fi.polar.polarflow.c.l p(b var0) {
      return var0.A;
   }
   ...
   private void s() {
      ...
      if (var1 != null) {
         ...
         if (this.j.a(fi.polar.polarflow.c.b.i.c) != null) {
   ...
   private void x() {
      ...
      this.m = 1;
      this.A();
      this.j.a(this.k, this.a, false, this.G, 2);
   }
   ...
   public void b() {
      ...
      this.n = true;
      if (!this.v()) {
         this.a((fi.polar.polarflow.c.m)fi.polar.polarflow.c.m.c, true);
         this.w();
      } else {
         this.d();
      }
   ...
   public void c() {
      ...
      this.C.removeCallbacksAndMessages((Object)null);
      this.a((fi.polar.polarflow.c.m)fi.polar.polarflow.c.m.b);
   }

   protected void d() {
      if (this.A != null) {
         this.h.post(new h(this, this.e()));
      }
