   ...
   private void b() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         if (this.c(var4) && this.e.get(var4) == null) {
            ...
            switch(var4) {
            case 1:
               var5 = new fi.polar.polarflow.c.c.j(this.b);
               break;
            case 4:
               var5 = new fi.polar.polarflow.c.d.b(this.b);
               break;
            case 8:
               var5 = new fi.polar.polarflow.c.a.e(this.b);
               break;
            case 16:
               var5 = new fi.polar.polarflow.c.a.a(this.b);
            }
