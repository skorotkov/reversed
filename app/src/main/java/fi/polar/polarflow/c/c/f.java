...
class f extends BluetoothGattCallback {
   ...
   public void onCharacteristicChanged(BluetoothGatt var1, BluetoothGattCharacteristic var2) {
      if (fi.polar.polarflow.c.b.i.i.equals(var2.getUuid())) {
         b.a(this.a, var2);
      }
   ...
   public void onCharacteristicRead(BluetoothGatt var1, BluetoothGattCharacteristic var2, int var3) {
      ...
      if (fi.polar.polarflow.c.b.i.h.equals(var2.getUuid())) {
         b.a(this.a, var2, var3);
      } else if (fi.polar.polarflow.c.b.i.d.equals(var2.getUuid())) {
         b.b(this.a, var2, var3);
      } else if (fi.polar.polarflow.c.b.i.e.equals(var2.getUuid())) {
         b.c(this.a, var2, var3);
      } else if (fi.polar.polarflow.c.b.i.f.equals(var2.getUuid())) {
         b.d(this.a, var2, var3);
      } else if (fi.polar.polarflow.c.b.i.g.equals(var2.getUuid())) {
   ...
   public void onConnectionStateChange(BluetoothGatt var1, int var2, int var3) {
      ...
      if (var3 == 2) {
         ...
         if (!b.a(this.a).d()) {
            ...
            b.b(this.a, fi.polar.polarflow.c.m.a);
            b.c(this.a);
         }
      } else if (b.d(this.a)) {
         if (var5 == 2) {
            b.c(this.a, fi.polar.polarflow.c.m.a);
            ...
            if (this.a(var2)) {
               ...
               b.d(this.a, fi.polar.polarflow.c.m.a);
            }
         }
      } else {
         b.e(this.a, fi.polar.polarflow.c.m.b);
      }
