...
class f extends BluetoothGattCallback {
   ...
   public void onCharacteristicChanged(BluetoothGatt var1, BluetoothGattCharacteristic var2) {
      if (fi.polar.polarflow.c_sensor_package.b_ble_package.i.i.equals(var2.getUuid())) {
   ...
   public void onCharacteristicRead(BluetoothGatt var1, BluetoothGattCharacteristic var2, int var3) {
      ...
      if (fi.polar.polarflow.c_sensor_package.b_ble_package.i.h.equals(var2.getUuid())) {
         b_BleHeartRateSensor.a(this.a, var2, var3);
      } else if (fi.polar.polarflow.c_sensor_package.b_ble_package.i.d.equals(var2.getUuid())) {
         b_BleHeartRateSensor.b(this.a, var2, var3);
      } else if (fi.polar.polarflow.c_sensor_package.b_ble_package.i.e.equals(var2.getUuid())) {
         b_BleHeartRateSensor.c(this.a, var2, var3);
      } else if (fi.polar.polarflow.c_sensor_package.b_ble_package.i.f.equals(var2.getUuid())) {
         b_BleHeartRateSensor.d(this.a, var2, var3);
      } else if (fi.polar.polarflow.c_sensor_package.b_ble_package.i.g.equals(var2.getUuid())) {
