...
public class b_BleHeartRateSensor extends a_HeartRateSensor {
   ...
   private void F() {
      if (!this.a(fi.polar.polarflow.c_sensor_package.b_ble_package.i.a, fi.polar.polarflow.c_sensor_package.b_ble_package.i.h)) {
   ...
   private void G() {
      if (!this.a(fi.polar.polarflow.c_sensor_package.b_ble_package.i.a, fi.polar.polarflow.c_sensor_package.b_ble_package.i.d)) {
   ...
   private void H() {
      if (!this.a(fi.polar.polarflow.c_sensor_package.b_ble_package.i.a, fi.polar.polarflow.c_sensor_package.b_ble_package.i.e)) {
   ...
   private void I() {
      if (!this.a(fi.polar.polarflow.c_sensor_package.b_ble_package.i.a, fi.polar.polarflow.c_sensor_package.b_ble_package.i.f)) {
   ...
   private void J() {
      if (!this.a(fi.polar.polarflow.c_sensor_package.b_ble_package.i.a, fi.polar.polarflow.c_sensor_package.b_ble_package.i.g)) {
   ...
   private void a(boolean var1) {
      BluetoothGattCharacteristic var2 = this.b(fi.polar.polarflow.c_sensor_package.b_ble_package.i.b, fi.polar.polarflow.c_sensor_package.b_ble_package.i.i);
      if (var2 != null) {
         BluetoothGattDescriptor var3 = var2.getDescriptor(fi.polar.polarflow.c_sensor_package.b_ble_package.i.j);
         if (var3 != null) {
            this.a(var3, var1);
         } else {
   ...
   private void s() {
      ...
      if (var1 != null) {
         ...
         if (this.j.a(fi.polar.polarflow.c_sensor_package.b_ble_package.i.c) != null) {
