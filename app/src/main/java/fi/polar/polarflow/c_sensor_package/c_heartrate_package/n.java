...
class n extends BroadcastReceiver {
   ...
   n(j_HeartRateSensorManager var1) {
      this.a = var1;
   }
   ...
   public void onReceive(Context var1, Intent var2) {
      if (j_HeartRateSensorManager.c(this.a)) {
         ...
         switch(var3) {
         case 0:
            j_HeartRateSensorManager.m(this.a).post(new r(this.a, (k)null));
            break;
         case 1:
            j_HeartRateSensorManager.m(this.a).post(new p(this.a, var2.getStringExtra("fi.polar.polarflow.KEY_BLUETOOTH_DEVICE_ADDRESS")));
            break;
         case 2:
            j_HeartRateSensorManager.m(this.a).post(new q(this.a, var2.getStringExtra("fi.polar.polarflow.KEY_BLUETOOTH_DEVICE_ADDRESS")));
         }
      }
